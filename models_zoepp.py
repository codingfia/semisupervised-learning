...
## forward model based on Zoeppritz equations
class forward_model_zoepp(nn.Module):
    ...
    def forward(self, x):
        ...
        # print("wavelet.shape = {}".format(self.wavelet.size()))
        ...
        synth = synth[...,::self.resolution_ratio] # vertical scale mismatch between seismic and EI
